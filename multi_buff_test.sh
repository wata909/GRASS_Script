...
while [ $i -le 13 ]
 do
 v.extract --overwrite input=point output=point_select where="cat="$i""
...
# v.overlay --overwrite ainput=point_select_patch binput=veg_merge output=veg_overlay_point"$i" operator=and
